...
\textbf{S2 Figure. \\}
\bigskip
\textbf{Categorization of multinomial logistic regression} % Please use "title case" (capitalize all terms in the title except conjunctions, prepositions, and articles).
}
\newline
...
\begin{figure}[!ht]
    \includegraphics[width=.8\linewidth]{softmax}
