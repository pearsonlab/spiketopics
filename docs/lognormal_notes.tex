...
\begin{align}
    \frac{\partial\mathcal{L}}{\partial \mu_{0u}} &= -(\mu_{0u} - m_0)\tau_0^2 + \sum_{u(m) = u} [N_{m} - \overline{e^{\eta_{m}}}] \\
    ...
    - \mu_{\beta ju} \overline{\tau_{\beta j}} + \sum_{u(m) = u} [N_{m} - \overline{e^{\eta_{m}}}] x_{mj}  \\
