...
This section follows the paper by Yu and Kobayashi (2006), as well as papers by Mithcell and Jamieson (1993) and Mitchell, Harper, and Jamieson (1995).
...
\begin{align}
    ...
    C_t(m, d) &= \mathcal{D}_{t|T}(m, d) = \mathcal{S}_{t-1}(m)p_m(d) \beta_t(m, d) \\
    &= \sum_n A(m, n) \mathcal{E}_{t-1}(n) p_m(d) \beta_t(m, d)
\end{align}
