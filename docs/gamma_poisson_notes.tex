...
\begin{equation}
    ...
    - f_{dik}(\nu)]
\end{equation}
with $k$ labeling hidden states, $i$ labeling levels of those states, and $f(\nu)$ a set of functions of the variational parameters, $\nu$, for the duration distribution.
