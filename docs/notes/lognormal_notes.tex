...
\begin{align}
    ...
    &= \left[ \sum_{tu} (N_{tu} + 1) \mu_{\eta tu} - 
...
\begin{align}
    ...
    N_{tu} + 1 - \exp\left(\mu_{tu} + \frac{1}{2} \Sigma_{tuu} \right) 
...
\begin{align}
    \mu_{tu} + \frac{1}{\tau}\exp\left(\mu_{tu} + \frac{1}{2} \sigma^2_{tu} \right)&= \mathbb{E}_q[\overline{\eta}_{tu}] + \frac{1}{\tau} (N_{tu} + 1) \\
