...
\begin{align}
    ...
    (\eta - \overline{\eta})^\top \Sigma_\varepsilon^{-1}(\eta - \overline{\eta})
    - \frac{1}{2} \log |\Sigma_\varepsilon| \right]\\
    ...
    &- \frac{1}{2} \mathbb{E}_q[\log |\Sigma_\varepsilon|] + const
\end{align}
...
\begin{align}
    -\frac{1}{2}\mathbb{E}_q[\log |\Sigma_\varepsilon|] &=
    -\frac{1}{2}\mathbb{E}_q[\log S + \log |\Omega|] \\
    &= -\frac{1}{2}\mathbb{E}_q[\sum_i \log \sigma^2_i + \log |\Omega|] \\
    &= \frac{1}{2}\sum_i \log \tau_i - \frac{1}{2}\mathbb{E}_q[\log |\Omega|] \\
    &= \frac{1}{2}\sum_i \log \tau_i - \sum_{i} (d - i)[\psi(\beta_i) - \psi(2\beta_i)]
\end{align}
where the last calculation follows from (\ref{Elogdet_Omega}).
