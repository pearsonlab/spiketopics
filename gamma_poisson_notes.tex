...
\begin{multline}
    ...
    \right] \\
    + U \overline{a_k} (\overline{\log b_k} - \psi(\varsigma_k + 1) + \log \rho_k) + \frac{U}{2} \overline{\log a_k}  \\
    + (\varsigma_k - 1) \overline{\log a_k} - \rho_k \overline{a_k} 
    + (\gamma_k - 1) \overline{\log b_k} - \eta_k \overline{b_k}
    \bigg] \\
